    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "LoginHistory", route: "/LoginHistory" },
        ],
      },
      // {
      //   icon: (
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Properties", route: "/properties/property-data" },
          { label: "Create Property ", route: "/properties/new-property" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Compaign", route: "/compaign/compaign-data" },
          { label: "Create Compaign ", route: "/compaign/new-compaign" },
        ],
      },
      {
        icon: (
